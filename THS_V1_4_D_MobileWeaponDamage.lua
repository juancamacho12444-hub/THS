--//====================================================
--// THS - Tactical Hitbox System V1.4-D
...
--[[
	...
	Esta V1.4-D agrega Damage Engine móvil + arma, conservando hitboxes auxiliares, Color Engine y Debug Engine,
...
function THS:SyncDamageSettingsToServer()
	-- En V1.4-D ya no sincronizamos con servidor.
...
self.Runtime.LastFPSUpdate = os.clock()
	...
	print("[THS] Tactical Hitbox System V1.4-D Mobile Weapon Damage iniciado.")
end
